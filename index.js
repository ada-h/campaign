let gallery = [
    {id: 7, type: 'video', src: "./assets/campaign-videos/j1.mp4", language: "eng", link: "https://youtu.be/raWPpg6tvbw"},
    {id: 14, type: 'img', src: "./assets/campaign-images/7.jpeg", language: "eng"}, 
    {id: 15, type: 'img', src: "./assets/campaign-images/8.jpeg", language: "eng"},
    {id: 16, type: 'img', src: "./assets/campaign-images/9.jpeg", language: "eng"},
    {id: 17, type: 'img', src: "./assets/campaign-images/10.jpeg", language: "eng"},
    {id: 18, type: 'img', src: "./assets/campaign-images/11.jpeg", language: "eng"},
    {id: 19, type: 'img', src: "./assets/campaign-images/12.jpeg", language: "eng"},
    ...
    {id: 20, type: 'img', src: "./assets/campaign-images/14.jpeg", language: "eng"},
    {id: 8, type: 'img', src: "./assets/campaign-images/13.jpeg", language: "eng"},
...
function displayGallery(list){
    for(let i=0; i < list.length; i++){
        ...
        if(val.type === "img"){
            ...
            <div>
                <img onclick=copyText("${val.link}")  class="icon" src="./assets/share.png" alt="share" />
            </div>
        </div>
        </div> `
